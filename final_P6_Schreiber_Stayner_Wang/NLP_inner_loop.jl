...
CMHroomoutput = getvalue(CMHRoom)
...
writecsv(filename_out, [roomOutput CMHroomoutput; zeros(1,7) CMHresult'; blankline; roomOutput CO2output; zeros(1,7) CO2result; blankline; roomOutput PM25output; zeros(1,7) PM25result; zeros(1,7) PM25Absorbedresult; blankline; roomOutput HUMIDoutput; zeros(1,7) HUMIDresult; zeros(1,7) HUMIDAbsorbedresult])
